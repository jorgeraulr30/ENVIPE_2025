...
setwd("C:/Users/jorge/OneDrive/Imágenes/Saved Pictures/Escritorio/UAQ/SEMESTRE 6/T1. ING MAT/BD ENVIPE CSV/2023")
...
write.csv(resultados_municipios, "resultados_municipios_2023.csv", row.names = FALSE)
